...
python tools/epub/inspect_epub.py tools/epub/openlogic-fr-ensembles-tableaux.epub
```

Le PDF reconstruit se trouve dans `tools/epub/direct-tex-check/source/locale/fr/reader.pdf`; le livre numérique dans `tools/epub/openlogic-fr-ensembles-tableaux.epub`. Le garde fixe `SOURCE_DATE_EPOCH=1788739200`. Les reçus de chaque tentative restent dans leur dossier.

La préparation EPUB vérifie les empreintes des 92 sources chargées, remplace 1 187 occurrences du raccourci de tokens et développe explicitement dix-neuf tokens à initiale majuscule selon les macros OpenLogic. Cette adaptation ne modifie pas le texte du PDF. Les cadres de règles et arbres de preuve sont conservés comme SVG avec descriptions françaises : 146 diagrammes au total, dont 32 dans le nouveau chapitre. Les grandes figures gardent une taille lisible et se parcourent horizontalement. Les 5 230 autres formules sont du MathML natif. Les 87 notes ont leurs liens aller et retour; les 101 exercices restent numérotés.

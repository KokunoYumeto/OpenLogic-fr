% Édition française OpenLogic : 111 unités sur 722, treize chapitres.
% LaTeX cumulatif contenant tout le texte de cette livraison.
% Styles, figures, bibliographie et instructions sont fournis dans le ZIP source.
% Les vingt importations du premier ordre inactives sont conservées dans les pilotes modulaires du ZIP.
...
\hypersetup{pdftitle={OpenLogic : édition française — Des ensembles à la logique du premier ordre},
pdfauthor={Open Logic Project ; traduction française assistée par IA},
pdfsubject={Ensembles, relations, fonctions, dénombrabilité, nombres, logique propositionnelle et logique du premier ordre, séquents, déduction naturelle, tableaux et déduction axiomatique},
...
\vspace{14mm}
{\sffamily\huge Des ensembles\\à la logique du premier ordre\par}
\vspace{5mm}
{\large Relations, fonctions, dénombrabilité et nombres :\\
syntaxe, sémantique et systèmes de preuve\par}
\vfill
{\large Onzième livraison : treize chapitres\par}
\vspace{4mm}
Cette livraison comprend quatre-vingt-dix-huit sections et leurs treize chapitres d’organisation,
soit 111 des 722 unités de contenu prévues pour l’édition intégrale.
...
propositionnelles. Le huitième introduit la logique du premier ordre :
formules, structures, satisfaction, énoncés, substitution, modèles,
correction et complétude. Le neuvième présente les systèmes de preuve,
leur correction et leur complétude. Le dixième développe le calcul
des séquents propositionnel. Le onzième expose la déduction naturelle :
règles, décharge des hypothèses, construction de dérivations,
cohérence et théorème de correction. Le douzième présente les tableaux
analytiques signés : règles, construction, dérivabilité, cohérence et
correction. Le treizième développe les dérivations axiomatiques :
...
% BEGIN embedded source: content/first-order-logic/introduction/introduction.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{introduction}


\olchapter{fol}{int}{Introduction à la logique du premier ordre}


% BEGIN embedded source: content/first-order-logic/introduction/first-order-logic.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/first-order-logic.tex



% BEGIN embedded source: content/first-order-logic/introduction/syntax.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/syntax.tex



% BEGIN embedded source: content/first-order-logic/introduction/formulas.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{formulas}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/formulas.tex



% BEGIN embedded source: content/first-order-logic/introduction/satisfaction.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/satisfaction.tex



% BEGIN embedded source: content/first-order-logic/introduction/sentences.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/sentences.tex



% BEGIN embedded source: content/first-order-logic/introduction/semantic-notions.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{semantic-notions}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/semantic-notions.tex



% BEGIN embedded source: content/first-order-logic/introduction/substitution.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/substitution.tex



% BEGIN embedded source: content/first-order-logic/introduction/models-theories.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/models-theories.tex



% BEGIN embedded source: content/first-order-logic/introduction/soundness-completeness.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/introduction/soundness-completeness.tex
...
\endgroup
% END embedded source: content/first-order-logic/introduction/introduction.tex
...
différents systèmes de !!{derivation} définissent donc différemment la
notion de \emph{théorème} et la relation qui exprime qu'un !!{sentence}
est !!{derivable} à partir d'autres !!{sentence}s.
...
% BEGIN embedded source: content/first-order-logic/sequent-calculus/sequent-calculus.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{sequent-calculus}
...
% BEGIN embedded source: content/first-order-logic/sequent-calculus/rules-and-proofs.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/rules-and-proofs.tex



% BEGIN embedded source: content/first-order-logic/sequent-calculus/propositional-rules.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\iftag{FOL}
      {\olfileid[fr]{fol}{seq}{prl}}
      {\olfileid[fr]{pl}{seq}{prl}}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/propositional-rules.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/sequent-calculus/structural-rules.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/structural-rules.tex



% BEGIN embedded source: content/first-order-logic/sequent-calculus/derivations.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/derivations.tex



% BEGIN embedded source: content/first-order-logic/sequent-calculus/proving-things.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/proving-things.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/sequent-calculus/proof-theoretic-notions.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/proof-theoretic-notions.tex



% BEGIN embedded source: content/first-order-logic/sequent-calculus/provability-consistency.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/provability-consistency.tex



% BEGIN embedded source: content/first-order-logic/sequent-calculus/provability-propositional.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/provability-propositional.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/sequent-calculus/soundness.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/soundness.tex
...
\endgroup
% END embedded source: content/first-order-logic/sequent-calculus/sequent-calculus.tex

\addtocontents{toc}{\protect\Needspace{4\baselineskip}}

% BEGIN embedded source: content/first-order-logic/natural-deduction/natural-deduction.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{natural-deduction}
...
naturelle en tant que système de preuve, utiliser l'étiquette « prfND ».
\end{editorial}


% BEGIN embedded source: content/first-order-logic/natural-deduction/rules-and-proofs.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{rules-and-proofs}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/rules-and-proofs.tex



% BEGIN embedded source: content/first-order-logic/natural-deduction/propositional-rules.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{propositional-rules}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/propositional-rules.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/natural-deduction/derivations.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{derivations}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/derivations.tex



% BEGIN embedded source: content/first-order-logic/natural-deduction/proving-things.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{proving-things}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/proving-things.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/natural-deduction/proof-theoretic-notions.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{proof-theoretic-notions}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/proof-theoretic-notions.tex



% BEGIN embedded source: content/first-order-logic/natural-deduction/provability-consistency.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{provability-consistency}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/provability-consistency.tex



% BEGIN embedded source: content/first-order-logic/natural-deduction/provability-propositional.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{provability-propositional}
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/provability-propositional.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/natural-deduction/soundness.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{soundness}
...
branche propositionnelle. La règle d'élimination universelle est
désignée de manière uniforme avec les autres règles.
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/soundness.tex
...
\endgroup
% END embedded source: content/first-order-logic/natural-deduction/natural-deduction.tex

\addtocontents{toc}{\protect\Needspace{4\baselineskip}}

% BEGIN embedded source: content/first-order-logic/tableaux/tableaux.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{tableaux}
...
% BEGIN embedded source: content/first-order-logic/tableaux/rules-and-proofs.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{rules-and-proofs}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/rules-and-proofs.tex



% BEGIN embedded source: content/first-order-logic/tableaux/propositional-rules.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{propositional-rules}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/propositional-rules.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/tableaux/derivations.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{derivations}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/derivations.tex



% BEGIN embedded source: content/first-order-logic/tableaux/proving-things.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{proving-things}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/proving-things.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/tableaux/proof-theoretic-notions.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{proof-theoretic-notions}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/proof-theoretic-notions.tex



% BEGIN embedded source: content/first-order-logic/tableaux/provability-consistency.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{provability-consistency}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/provability-consistency.tex



% BEGIN embedded source: content/first-order-logic/tableaux/provability-propositional.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{provability-propositional}
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/provability-propositional.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/tableaux/soundness.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{soundness}
...
\item La branche est prolongée par l'application de
  ...
  $\Sat{M}{\lforall[x][!A(x)]}$. D'après la
...
\item La branche est prolongée par l'application de
  ...
  D'après la \olref[syn][ass]{prop:sat-quant},
  ...
  D'après la \olref[syn][ext]{prop:extensionality},
  $\Sat/{M'}{!A(x)}[s]$. Puis
...
!!{tableau} fermé pour
$\{\sFmla{\True}{!B_1}, \dots, \sFmla{\True}{!B_n}\}$. D'après le
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/soundness.tex
...
\endgroup
% END embedded source: content/first-order-logic/tableaux/tableaux.tex

\addtocontents{toc}{\protect\Needspace{4\baselineskip}}

% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/axiomatic-deduction.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{axiomatic-deduction}
...
% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/rules-and-proofs.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{rules-and-proofs}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/rules-and-proofs.tex



% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/axioms-rules-propositional.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/axioms-rules-propositional.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/proving-things.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{proving-things}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/proving-things.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/proof-theoretic-notions.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{proof-theoretic-notions}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/proof-theoretic-notions.tex



% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/deduction-theorem.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/deduction-theorem.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/provability-consistency.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{provability-consistency}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/provability-consistency.tex



% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/provability-propositional.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{provability-propositional}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/provability-propositional.tex


% Importations du premier ordre inactives dans cette livraison.


% BEGIN embedded source: content/first-order-logic/axiomatic-deduction/soundness.tex
\begingroup
\expandafter\def\csname ol@sectioncs\endcsname{section}
\def\olfilename{soundness}
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/soundness.tex
...
\endgroup
% END embedded source: content/first-order-logic/axiomatic-deduction/axiomatic-deduction.tex

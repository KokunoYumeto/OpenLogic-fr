% Édition française OpenLogic :74unités sur722,neuf chapitres.
...
% Les cinq importations du premier ordre inactives sont conservées dans le pilote modulaire du ZIP.
...
\hypersetup{pdftitle={OpenLogic : édition française — Des ensembles au calcul des séquents},
pdfauthor={Open Logic Project ; traduction française assistée par IA},
pdfsubject={Ensembles, relations, fonctions, dénombrabilité, nombres, logique propositionnelle et calcul des séquents},
...
\vspace{14mm}
{\sffamily\huge Des ensembles\\au calcul des séquents\par}
\vspace{5mm}
{\large Relations, fonctions, dénombrabilité et nombres :\\
syntaxe, sémantique et systèmes de preuve\par}
\vfill
{\large Septième livraison : neuf chapitres\par}
\vspace{4mm}
Cette livraison comprend soixante-cinq sections et leurs neuf chapitres d’organisation,
soit 74 des 722 unités de contenu prévues pour l’édition intégrale.
...
Le neuvième développe le calcul des séquents propositionnel : règles,
recherche de preuves, dérivabilité, cohérence et théorème de correction.
\vspace{7mm}
\par\small

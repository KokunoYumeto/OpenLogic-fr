% Édition française OpenLogic : 92 unités sur 722, onze chapitres.
...
% Les quinze importations du premier ordre inactives sont conservées dans les pilotes modulaires du ZIP.
...
\hypersetup{pdftitle={OpenLogic : édition française — Des ensembles aux tableaux},
pdfauthor={Open Logic Project ; traduction française assistée par IA},
pdfsubject={Ensembles, relations, fonctions, dénombrabilité, nombres, logique propositionnelle, séquents, déduction naturelle et tableaux},
...
\vspace{14mm}
{\sffamily\huge Des ensembles\\aux tableaux\par}
\vspace{5mm}
{\large Relations, fonctions, dénombrabilité et nombres :\\
syntaxe, sémantique et systèmes de preuve\par}
\vfill
{\large Neuvième livraison : onze chapitres\par}
\vspace{4mm}
Cette livraison comprend quatre-vingt-une sections et leurs onze chapitres d’organisation,
soit 92 des 722 unités de contenu prévues pour l’édition intégrale.
